			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="social-link">
						<a href=""><i class="fab fa-apple color1"></i></a>
						<a href=""><i class="fab fa-angellist color2"></i></a>
						<a href=""><i class="fab fa-amazon-pay color3"></i></a>
						<a href=""><i class="fab fa-acquisitions-incorporated color4"></i></a>
						<a href=""><i class="fas fa-american-sign-language-interpreting color5"></i></a>
					</div>
				</div>
				<div class="col-md-3">
					<div class="widget-text-title">
				...
				<div class="col-md-3">
					...
					<div class="widgets-content">
						<ul>
							<li><a href="#">01967169189</a></li>
							<li><a href="#">info@bubt.edu.bd</a></li>
							<li><a href="#">Rupnagar, Mirpur-2, Dhaka-1216, Bangladesh</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col">
					<div class="footer-title">
						<p>Copyright ©2022 <span>BackSpace</span> All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
