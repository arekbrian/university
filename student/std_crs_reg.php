...
if (isset($_GET['reg_course_id'])) {
    ...
    $query = "INSERT INTO course_registration(cr_student_id,cr_course_id,cr_dept_id,cr_intake_id,cr_section_id,cr_sem) VALUES('$std_id',$reg_course_id,$std_dept_id,$std_intake_id,$std_section_id,'$cr_sem')";
    $insert_query_rslt = mysqli_query($connection,$query);
    
    if ($insert_query_rslt) {

        $insert_crs_rslt_query = "INSERT INTO student_result(std_id,std_dept_id,std_intake_id,std_section_id,std_course_id,std_courese_sem) VALUES('$std_id',$std_dept_id,$std_intake_id,$std_section_id,$reg_course_id,'$cr_sem')";

        $insert_crs_rslt_query_rslt = mysqli_query($connection,$insert_crs_rslt_query);
        if ($insert_crs_rslt_query_rslt) {
             header("Location: std_crs_reg.php");
        }else{
           die("insert_crs_rslt_query_rslt failed".mysqli_error($connection)); 
        }
                        ...
                        <div class="info-area-innner">
                            ...
                            <div class="stident-info-menu">
                                <ul class="menu-list">
                                    ...
                                    <li><a href="std_completed_crs.php">Completeted Courses</a></li>
                                     <li><a href="std_completed_crs.php">Incompleted Courses</a></li>
                                    <li><a href="std_retake_crs.php">Retake Courses</a></li>
                                    <li><a href="std_improvement_crs.php">Improvement Courses</a></li>
                                </ul>
                            </div>
