...
<?php include "includes/header.php"; ?> 
	...
	<div class="slide owl-carousel">
		<div class="banner-img banner-bg">
			<div class="banner-text">
				...
				<p>We provides our best service and teaching policy.</p>
				<a href="#">LEARN MORE</a>
			</div>
		</div>
		<div class="banner-img banner-bg1">
			<div class="banner-text2">
				<h4>FEED YOUR KNOWLEDGE</h4>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 margin">
					<div class="discount-area discount-bg">
						<div class="discount-title">
							<h2>GET 30% DISCOUNT IN ALL SHIFT</h2>
				...
				<div class="col-md-6 margin">
					<div class="discount-area discount-bg1">
						<div class="discount-title">
							<h2>WANT TO GET ADMISSION NOW?</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas odit unde dolor inventore autem quod vero incidunt labore sunt reprehenderit.</p>
							<a href="#">LEARM MORE</a>
						</div>
					</div>
			...
			<div class="row justify-content-md-center">
				<div class="col-md-5">
					<div class="depart-title">
						<h2>Our <span>Department</span></h2>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="depart-content">
						<img src="assets/image/group1.jpg" alt="">
						<!-- <h4>Subtitle Here</h4> -->
						<h2>CSE</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas odit unde dolor inventore autem quod vero incidunt labore sunt reprehenderit.</p>
						<a href="#">Read More</a>
				...
				<div class="col-md-4">
					<div class="depart-content">
						<img src="assets/image/group3.jpg" alt="">
						<!-- <h4>Subtitle Here</h4> -->
						<h2>EEE</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas odit unde dolor inventore autem quod vero incidunt labore sunt reprehenderit.</p>
						<a href="#">Read More</a>
	...
	<div class="mission-area">
		<div class="row">
			<div class="col-md-6">
				<div class="mission-img mission-bg"></div>
			</div>
			<div class="col-md-6">
	...
	<div class="teacher-area">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="depart-content">
						<img src="assets/image/head1.jpg" alt="">
						<h2>MD. MURSHED</h2>
				...
				<div class="col-md-3">
					<div class="depart-content">
						<img src="assets/image/head3.jpg" alt="">
						<h2>MD. NAZMUL HAQUE</h2>
				...
				<div class="col-md-3">
					<div class="depart-content">
						<img src="assets/image/head4.jpg" alt="">
						<h2>MILON KUMAR</h2>
						<p>Assistant Teacher</p>
						<a href="#">Read More</a>
					</div>
	...
	<div class="gallery-area gallery-bg">
		<div class="row justify-content-md-center">
			<div class="col-md-5">
				<div class="depart-title galler-title">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="gallery-img">
						<img src="assets/image/g7.jpg" alt="">
						<h4>TITLE HERE</h4>
					</div>
				</div>
				<div class="col-md-3">
					<div class="gallery-img">
						<img src="assets/image/g8.jpg" alt="">
						<h4>TITLE HERE</h4>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="recent-content">
						<img src="assets/image/recent1.jpg" alt="">
						<h2>This Is A Standard Post With Thumbnail</h2>
				...
				<div class="col-md-4">
					<div class="recent-content">
						<img src="assets/image/recent2.jpg" alt="">
						<h2>This Is A Standard Post With Thumbnail</h2>
						<span><i class="fa fa-commenting-o" aria-hidden="true"></i> 214 Comments</span>
						<span><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>895 Likes</span>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas odit unde dolor inventore autem quod vero incidunt labore sunt reprehenderit.</p>
				...
				<div class="col-md-4">
					<div class="recent-content">
						<img src="assets/image/recent3.jpg" alt="">
						<h2>This Is A Standard Post With Thumbnail</h2>
						<span><i class="fa fa-commenting-o" aria-hidden="true"></i> 214 Comments</span>
						<span><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>895 Likes</span>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas odit unde dolor inventore autem quod vero incidunt labore sunt reprehenderit.</p>
